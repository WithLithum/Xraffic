            ...
            GameFiber.StartNew(delegate
            {
                try
                {
                    ...
                    if (SuccessfulSet)
                    {
                        ...
                        {
                            API.LspdfrPlusWrapper.AddCountToStatistic(Main.PluginName, "Custom pullover locations set");
                        }
        ...
        public static void mimicMe()
        {
            ...
            GameFiber.StartNew(delegate
            {
                try
                {
                    ...
                    if (TrafficPolicerHandler.IsLSPDFRPlusRunning)
                    {
                        API.LspdfrPlusWrapper.AddCountToStatistic(Main.PluginName, "Vehicles Mimicked");
                    }
                    //Driving loop
                    while (true)
                    {
        ...
        public static void followMe()
        {
            ...
            GameFiber.StartNew(delegate
            {
                try
                {
                    ...
                    if (TrafficPolicerHandler.IsLSPDFRPlusRunning)
                    {
                        API.LspdfrPlusWrapper.AddCountToStatistic(Main.PluginName, "Vehicles made to follow you");
                    }
